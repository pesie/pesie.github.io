...
<div class="col-lg-10">
 <input class="form-control" type="text" name="inputName" placeholder="Ned Stark" id="name" required>
 </div>
</div>
...
<div class="col-lg-10">
<input class="form-control" type="inputEmail" id="email" placeholder="ned@winterfell.com" required>
</div>
</div>
