...
Several estimators address this, including [Callaway and Sant'Anna (2021)](https://www.sciencedirect.com/science/article/abs/pii/S0304407620303948), which estimates effects separately by adoption cohort before aggregating.

::: {.callout-note appearance="minimal"}
I've worked through staggered DiD in practice. My analysis of state cannabis legalization and youth use spans 374 state-years and ran into exactly this problem. The code is available [here](https://github.com/pesie/yrbs-cannabis-did).
:::
